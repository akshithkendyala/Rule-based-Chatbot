...
#Install NLTK -> Natural language tool kit (command: "pip install nltk") in the terminal
...
class RuleBasedChatbot:
    def __init__(self, pairs):
        self.chat = Chat(pairs, reflections) #matches the patterns & returns corresponding responses
    #responds according to the user_input
    def respond(self, user_input):
        return self.chat.respond(user_input)
    
#Interacting with Chatbot
#Here we will continuosly prompt the user for input and display the responses until "exit" is typed
def chat_with_bot():
